...
const request = axios.create({ baseURL: 'http://localhost:8081/api/member-portal', timeout: 10000 });
request.interceptors.request.use(c => { const t = localStorage.getItem('m_token'); if (t) c.headers.Authorization = 'Bearer ' + t; return c; });
