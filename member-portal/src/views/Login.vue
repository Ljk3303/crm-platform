...
<div class="auth-page">
  <div class="auth-card">
    ...
    <el-form @submit.prevent="doLogin" size="large">
      ...
      <el-form-item><el-input v-model="password" type="password" placeholder="密码" prefix-icon="Lock" show-password style="height:48px"/></el-form-item>
      <el-form-item><el-button type="primary" native-type="submit" :loading="loading" style="width:100%;height:48px;border-radius:12px;font-size:16px;font-weight:700;background:linear-gradient(135deg,#FF6B35,#F7B731);border:none">登录</el-button></el-form-item>
    </el-form>
    <div class="auth-footer">
      还没有账号？<router-link to="/register" style="color:#FF6B35;font-weight:600">立即注册</router-link>
    </div>
    <div class="auth-demo">演示账号：13800000000 / 123456</div>
  </div>
</div>
</template>
...
.auth-demo{text-align:center;margin-top:16px;font-size:12px;color:#9CA3AF;background:#F8FAFC;padding:8px;border-radius:8px}
</style>
