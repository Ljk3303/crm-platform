...
const fetchStageHistory = async () => {
  try {
    ...
    stageHistory.value = res.data?.items || res.data || []
  } catch (e) { /* ignore */ }
}
...
const fetchTeamMembers = async () => {
  try {
    ...
    teamMembers.value = res.data?.items || res.data || []
  } catch (e) { /* ignore */ }
}
...
const fetchCompetitors = async () => {
  try {
    ...
    competitors.value = res.data?.items || res.data || []
  } catch (e) { /* ignore */ }
}
...
const fetchAIScript = async () => {
  ...
  try {
    ...
    aiScripts.value = res.data?.items || res.data || []
