...
async function fetchPending() {
  ...
  try {
    ...
    pendingList.value = res.data?.records || res.data?.list || res.data || []
  } catch {
...
async function fetchProcessed() {
  ...
  try {
    ...
    const allFlows = res.data?.records || res.data?.list || res.data || []
...
async function fetchSubmitted() {
  ...
  try {
    const res = await approvalApi.flows()
    submittedList.value = res.data?.records || res.data?.list || res.data || []
  } catch {
